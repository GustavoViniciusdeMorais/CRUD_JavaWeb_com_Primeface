...
public class ProdutoDAO {
	...
	public void salvar(Produto objP) throws SQLException {
		...
		comando.setString(1, objP.getDescricao());
		comando.setDouble(2, objP.getPreco());
		comando.setLong(3, objP.getQuantidade());
		comando.setLong(4, objP.getFabricante().getCodigo());
